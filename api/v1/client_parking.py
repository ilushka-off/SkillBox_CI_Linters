...
@router.post("", status_code=status.HTTP_201_CREATED, response_model=ClientParkingGetSchema)
...
@router.delete("", status_code=status.HTTP_200_OK, response_model=ClientParkingGetSchema)
